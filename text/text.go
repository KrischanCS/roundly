// Package text Provides functions to add text to elements or attributes, either
// escaped of not.
//
// The not escaped version should only be used with trusted text and never with
// user input.
package text
