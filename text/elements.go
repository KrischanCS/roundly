...
// DelTf creates an [element.Del] without any attributes and the formatted template as its only child.
...
// InsTf creates an [element.Ins] without any attributes and the formatted template as its only child.
...
// ButtonTf creates an [element.Button] without any attributes and the formatted template as its only child.
...
// LegendTf creates an [element.Legend] without any attributes and the formatted template as its only child.
...
// OptionTf creates an [element.Option] without any attributes and the formatted template as its only child.
...
// OutputTf creates an [element.Output] without any attributes and the formatted template as its only child.
...
// ProgressTf creates an [element.Progress] without any attributes and the formatted template as its only child.
...
// TextareaTf creates an [element.Textarea] without any attributes and the formatted template as its only child.
...
// LabelTf creates an [element.Label] without any attributes and the formatted template as its only child.
...
// BlockquoteTf creates an [element.Blockquote] without any attributes and the formatted template as its only child.
...
// FigcaptionTf creates an [element.Figcaption] without any attributes and the formatted template as its only child.
...
// PreTf creates an [element.Pre] without any attributes and the formatted template as its only child.
...
// SummaryTf creates an [element.Summary] without any attributes and the formatted template as its only child.
...
// NoscriptTf creates an [element.Noscript] without any attributes and the formatted template as its only child.
...
// TitleTf creates an [element.Title] without any attributes and the formatted template as its only child.
...
// CaptionTf creates an [element.Caption] without any attributes and the formatted template as its only child.
...
// AbbrTf creates an [element.Abbr] without any attributes and the formatted template as its only child.
...
// CiteTf creates an [element.Cite] without any attributes and the formatted template as its only child.
...
// CodeTf creates an [element.Code] without any attributes and the formatted template as its only child.
...
// DataTf creates an [element.Data] without any attributes and the formatted template as its only child.
...
// DfnTf creates an [element.Dfn] without any attributes and the formatted template as its only child.
...
// KbdTf creates an [element.Kbd] without any attributes and the formatted template as its only child.
...
// MarkTf creates an [element.Mark] without any attributes and the formatted template as its only child.
...
// SampTf creates an [element.Samp] without any attributes and the formatted template as its only child.
...
// SmallTf creates an [element.Small] without any attributes and the formatted template as its only child.
...
// SpanTf creates an [element.Span] without any attributes and the formatted template as its only child.
...
// StrongTf creates an [element.Strong] without any attributes and the formatted template as its only child.
...
// SubTf creates an [element.Sub] without any attributes and the formatted template as its only child.
...
// SupTf creates an [element.Sup] without any attributes and the formatted template as its only child.
...
// VarTf creates an [element.Var] without any attributes and the formatted template as its only child.
